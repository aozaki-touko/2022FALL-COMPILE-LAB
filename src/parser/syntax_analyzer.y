...
%token <node> LBRACKET
%token <node> RBRACKET
%token <node> OPENBRACKET
%token <node> CLOSEBRACKET
%token <node> OPENBRACE
%token <node> CLOSEBRACE
%token <node> ID
%token <node> FLOATNUM
%token <node> INTEGER
%type <node> program
...
var-declaration:type-specifier ID SEMICOLON {$$ = node("var-declaration",3,$1,$2,$3);}
                |type-specifier ID OPENBRACKET INTEGER CLOSEBRACKET SEMICOLON{$$ = node("var-declaration",6,$1,$2,$3,$4,$5,$6);}
type-specifier:INT{$$ = node("type-specifier",1,$1);}
                |FLOAT {$$ = node("type-specifier",1,$1);}
                |VOID  {$$ = node("type-specifier",1,$1);}
fun-declaration:type-specifier ID LBRACKET params RBRACKET compound-stmt {$$ = node("fun-declaration",6,$1,$2,$3,$4,$5,$6);}
...
selection-stmt: IF LBRACKET expression RBRACKET statement {$$ = node("selection-stmt",5,$1,$2,$3,$4,$5);}
                |IF LBRACKET expression RBRACKET statement ELSE statement{$$ = node("selection-stmt",7,$1,$2,$3,$4,$5,$6,$7);}
iteration-stmt: WHILE LBRACKET expression RBRACKET statement{$$ = node("iteration-stmt",5,$1,$2,$3,$4,$5);}
return-stmt: RET SEMICOLON{$$ = node("return-stmt",2,$1,$2);}
...
mulop:MUL  {$$ = node("mulop",1,$1);}
        |DIV  {$$ = node("mulop",1,$1);}
factor:LBRACKET expression RBRACKET {$$ = node("factor",3,$1,$2,$3);}
    |var  {$$ = node("factor",1,$1);}
...
call:ID LBRACKET args RBRACKET {$$ = node("call",4,$1,$2,$3,$4);}
